...
const Signin = {
    ...
    <div class="max-w-md w-full space-y-8">
      <div>
        ...
        <h2 class="mt-6 text-center text-2xl font-extrabold text-blue-900">Đăng nhập vào tài khoản của bạn</h2>
      ...
      <form class="mt-8 space-y-6" action="#" id="formSignin" >
        ...
        <div class="flex items-center justify-between">
          ...
          <div class="text-sm">
            <a href="#" class="font-medium text-blue-500 hover:text-indigo-500"> Quên mật khẩu? </a>
          </div>
        </div>
        <div class="text-sm">
        <a href="signup" class="font-medium text-blue-500 hover:text-indigo-500"> Tôi chưa có tài khoản thành viên! </a>
      </div>
        <div>
    ...
    afterRender() {
        ...
        formSignin.addEventListener("submit", async(e) => {
            ...
            try {
                ...
                toastr.success("Sai tài khoản hoặc mật khẩu. Vui lòng nhập lại!")
